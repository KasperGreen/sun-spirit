...
export default {
  left: {
    [LANG_RU]: <div>
      ...
      <p>Бахчисарайский район, с. Холмовка Красномакского сельского поселения, ущелье &laquo;Черкез-Кермен&raquo;.</p>
      <p>Это соседняя долина от&nbsp;долины древнего пещерного города &laquo;Эски-Кермен&raquo;.</p>
    </div>,
    [LANG_EN]: <div>
      ...
      <p>It&rsquo;s the next valley to&nbsp;the ancient cave town, Eski-Kermen</p>
    </div>,
  },
  right: {
    [LANG_RU]: <div>
      ...
      <ul>
        ...
        <li>Симферополь, 56&nbsp;км;</li>
        <li>Бахчисарай, 16&nbsp;км.</li>
      </ul>
    </div>,
    [LANG_EN]: <div>
