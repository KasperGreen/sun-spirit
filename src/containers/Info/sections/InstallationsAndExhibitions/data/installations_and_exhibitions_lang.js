...
export default {
  left: {
    [LANG_RU]: <div><p><b>Фестиваль&nbsp;&mdash; это место для творческого самовыражения!</b></p>
      <p>Sun spirit Festival&nbsp;&mdash; большая арт инсталляция, художественно проработанные элементы которой несут
