...
export default {
  about_festival: {
    [LANG_RU]: <div className="text">
      ...
      наполнение:</p><p>
      <b>«АТМОСФЕРА»</b> - это сцена электронной музыки. Артисты сцены легко и непринужденно погрузят гостей в
      вибрации динамичного и атмосферного звучания от Electronic и Breaks до IDM и Downtempo;</p><p>
      <b>«БИОСФЕРА»</b> - это сцена живой музыки. Пересечение чистой импровизации и живого процесса
      музицирования.
      ...
      направления
      Cinema - площадка кинопоказов, видео перфомансов и Ambient - малая звуковая сцена безбитовой музыки. В
    ...
    [LANG_EN]: <div>
      Английский текст о фестивале нужно написать тому, кто хорошо пишет по английски. Каспер не очень хорошо говорит по английски
    </div>
  },
}
