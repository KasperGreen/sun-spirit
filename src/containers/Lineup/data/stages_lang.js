...
import atmosphere_right_image from '../images/atmosphere_90.jpg'
import biosphere_image from '../images/biosphere.jpg'
import biosphere_right_image from '../images/biosphere_90.jpg'
import silent_image from '../images/silent.jpg'
import silent_right_image from '../images/silent_big.jpg'
...
export default {
  atmosphere: {
    ...
    right_image_url: atmosphere_right_image,
    description: {
      ...
      [LANG_EN]: <div>
        &laquo;<strong>Atmosphere</strong>&raquo; is&nbsp;an&nbsp;electronic music stage. The artists will easily
        immerse
  ...
  biosphere: {
    ...
    right_image_url: biosphere_right_image,
    ...
    description: {
      ...
      [LANG_EN]: <div>
        &laquo;<strong>Biosphere</strong>&raquo; is&nbsp;a&nbsp;life music stage. Combination of&nbsp;pure improvisation
        and
  ...
  silent: {
    ...
    right_image_url: silent_right_image,
    description: {
      [LANG_RU]: <div>
        <p>
          <b>&laquo;ТИШИНА&raquo;</b>&nbsp;&mdash; локация визуального и&nbsp;слухового, слияние зримого
          и&nbsp;незримого. Включает в&nbsp;себя
          направления
          ...
          представленные картины, насладится чаепитиями в&nbsp;чайном баре, выполненном в&nbsp;японском стиле под
          невероятные
          музыкальные произведения.</p>
      </div>,
      [LANG_EN]: <div>

        &laquo;<strong>Silence</strong>&raquo; is&nbsp;a&nbsp;location of&nbsp;visual and aсoustic, fusion
        ...
        stage of&nbsp;non-beat music. In&nbsp;the framework of&nbsp;the location visitors can enjoy the open air cinema,
        discuss the
        represented films with the directors, take part in&nbsp;tea ceremonies in&nbsp;a&nbsp;Japanese style bar
        listening to
